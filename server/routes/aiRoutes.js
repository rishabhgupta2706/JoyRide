        ...
        try {
            ...
            if (budget !== null) {
                filteredBikes = filteredBikes.filter(
                    (bike) =>
                        Number(bike.pricePerHour) <= budget
                );
            }

            // Location is a hard requirement
            ...
            const scoredBikes = filteredBikes.map((bike) => {
                ...
                if (
                    ...
                    uniqueReasons.push(
                        "Available for your selected requirements"
                    );
                }
            ...
            scoredBikes.sort((a, b) => {
                ...
                // If scores are equal,
                // prefer the cheaper bike
                return (
                    Number(a.bike.pricePerHour) -
                    Number(b.bike.pricePerHour)
                );
            });
